...
public class PublicCatalogController {
    ...
    public ResponseEntity<Page<PublicProduitResponse>> listerNouveautesDeMesFournisseurs(
            @AuthenticationPrincipal UUID clientId,
            @PageableDefault(sort = "createdAt", direction = Sort.Direction.DESC) Pageable pageable) {
        return ResponseEntity.ok(produitService.listerNouveautesDeMesFournisseurs(clientId, pageable));
    }
